...
p=ncol(X)-1
#iteration times
k=11  # i find that after 9 times, it seems it is already around the limit point.But I still set the upper iteration times here to pretend i do not know it.
```
